...
batch. `disconnect()` and `sync("reverse-duplicate")` exercise reconnect and
...
| SS-3.4 | 360 facts, 100-item pages, finite catch-up, duplicate/reversed replay, retained history |
